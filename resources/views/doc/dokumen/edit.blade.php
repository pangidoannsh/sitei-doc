                    ...
                    <select name="semester" id="semester"
                        ...
                        @foreach ($semesters as $semester)
                            <option value="{{ $semester->nama }}" class="text-capitalize"
                                {{ old('semester') == $semester->nama || $dokumen->semester == $semester->nama ? 'selected' : '' }}>
                                {{ $semester->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="d-flex gap-2 align-items-center">
                    @if ($dokumen->url_dokumen || $dokumen->url_dokumen_lokal)
                        ...
                        @if ($dokumen->url_dokumen)
                            <a href="{{ $dokumen->url_dokumen }}" target="_blank" class="btn btn-success">
                                Lampiran saat ini
                            </a>
                        @endif
                    @else
            ...
            <div class="gap-4 align-items-center d-none bg-white p-4 pt-5 rounded-3 position-relative" id="input-dokumen">
                ...
                <div class="w-100">
                    ...
                    <input type="url" class="form-control rounded-3"
                        value="{{ old('url_dokumen') ?? $dokumen->url_dokumen }}" name="url_dokumen"
                                    ...
                                    @if ($key < $halfIndex)
                                        <div class="form-check">
                                            <input class="form-check-input dosen-selector" type="checkbox"
                                                ...
                                                {{ in_array($dosen->nip, $dokumen->mentions->pluck('dosen.nip')->toArray()) ? 'checked' : '' }}>
                            ...
                            @foreach ($staffs as $staff)
                                <div class="form-check">
                                    <input class="form-check-input staf-selector" type="checkbox"
                                        ...
                                        {{ in_array($staff->username, $dokumen->mentions->pluck('admin.username')->toArray()) ? 'checked' : '' }}>
                                    ...
                                    @foreach ($mahasiswas['1']->sortKeys() as $angkatan => $angkatans)
                                        <div id="1_{{ $angkatan }}" style="min-width: 100px;cursor: pointer;"
                                            ...
                                            <input class="form-check-input angkatan-selector d3te-selector"
                                                ...
                                                {{ in_array("d3te_$angkatan", $dokumen->mentions->pluck('user_mentioned')->toArray()) ? 'checked' : '' }}>
                                            {{ $angkatan }}
                                        </div>
                                        @php
                                            $isActive = false;
                                            ...
                                            @foreach ($angkatans->sortBy('nama') as $mahasiswa)
                                                <div class="col form-check mb-2">
                                                    <input class="form-check-input mahasiswa-selector d3te-selector"
                                                        ...
                                                        name="mahasiswa[]"
                                                        {{ in_array($mahasiswa->nim, $dokumen->mentions->pluck('user_mentioned')->toArray()) ||
                                                        in_array("d3te_$angkatan", $dokumen->mentions->pluck('user_mentioned')->toArray())
                                                            ? 'checked'
                                                            : '' }}>
                                    ...
                                    @foreach ($mahasiswas['2']->sortKeys() as $angkatan => $angkatans)
                                        <div id="2_{{ $angkatan }}" style="min-width: 100px;cursor: pointer;"
                                            ...
                                            <input class="form-check-input angkatan-selector s1te-selector"
                                                ...
                                                {{ in_array("s1te_$angkatan", $dokumen->mentions->pluck('user_mentioned')->toArray()) ? 'checked' : '' }}>
                                            {{ $angkatan }}
                                        </div>
                                        @php
                                            $isActive = false;
                                            ...
                                            @foreach ($angkatans->sortBy('nama') as $mahasiswa)
                                                <div class="col form-check mb-2">
                                                    <input class="form-check-input mahasiswa-selector s1te-selector"
                                                        ...
                                                        name="mahasiswa[]"
                                                        {{ in_array($mahasiswa->nim, $dokumen->mentions->pluck('user_mentioned')->toArray()) ||
                                                        in_array("s1te_$angkatan", $dokumen->mentions->pluck('user_mentioned')->toArray())
                                                            ? 'checked'
                                                            : '' }}>
                                                    <label class="form-check-label text-capitalize"
                                    ...
                                    @foreach ($mahasiswas['3']->sortKeys() as $angkatan => $angkatans)
                                        <div id="3_{{ $angkatan }}" style="min-width: 100px;cursor: pointer;"
                                            ...
                                            <input class="form-check-input angkatan-selector s1ti-selector"
                                                ...
                                                {{ in_array("s1ti_$angkatan", $dokumen->mentions->pluck('user_mentioned')->toArray()) ? 'checked' : '' }}>
                                            {{ $angkatan }}
                                        </div>
                                        @php
                                            $isActive = false;
                                            ...
                                            @foreach ($angkatans->sortBy('nama') as $mahasiswa)
                                                <div class="col form-check mb-2">
                                                    <input class="form-check-input mahasiswa-selector s1ti-selector"
                                                        ...
                                                        {{ in_array($mahasiswa->nim, $dokumen->mentions->pluck('user_mentioned')->toArray()) ||
                                                        in_array("s1ti_$angkatan", $dokumen->mentions->pluck('user_mentioned')->toArray())
                                                            ? 'checked'
                                                            : '' }}>
                                                    <label class="form-check-label text-capitalize"
